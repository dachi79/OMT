...
*/
$odeca=array("muskarci","zene");

?>
<form action="" method="post">
<select>
	<option value=-1>Izaberite garderobu</option>
	<option value="<?php $_POST['pol']='muskarci'; ?>">Muska odeća</option>
	<option value="<?php $_POST['pol']='zene'; ?>">Ženska odeća</option>
</select>
<br><br><br>
<input type="text" name="pol" value="<? $_POST['pol']; ?>">
<br><br>
<input type="submit" name="submit" value="pruzmi"><br><br>
</form>
<?php
$pol=$_POST['pol'];
